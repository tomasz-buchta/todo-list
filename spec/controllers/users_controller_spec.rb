...
RSpec.describe UsersController, type: :controller do
  ...
  describe "GET #edit" do
    it "assigns the requested user as @user" do
      user = User.create! valid_attributes
      get :edit, {:id => user.to_param,format: :json}, valid_session
      expect(assigns(:user)).to eq(user)
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested user" do
        user = User.create! valid_attributes
        put :update, {:id => user.to_param, :user => new_attributes,format: :json}, valid_session
        user.reload
    ...
    context "with invalid params" do
      it "assigns the user as @user" do
        user = User.create! valid_attributes
        put :update, {:id => user.to_param, :user => invalid_attributes,format: :json}, valid_session
        expect(assigns(:user)).to eq(user)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested user" do
      user = User.create! valid_attributes
      expect {
        delete :destroy, {:id => user.to_param,format: :json}, valid_session
      }.to change(User, :count).by(-1)
    end
